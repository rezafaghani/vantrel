...
See [docs/architecture/platform-architecture.md](docs/architecture/platform-architecture.md) for the intended high-level platform architecture, [docs/adr](docs/adr) for architecture decisions, [docs/specs/mrx-v0.md](docs/specs/mrx-v0.md) for the draft MRX raw archive specification, [libs/go/mrx](libs/go/mrx) for the initial Go MRX library and CLI, and [docs/kubernetes/local-development.md](docs/kubernetes/local-development.md) for the local Kubernetes foundation.
